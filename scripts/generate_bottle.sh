...
mkdir -p ${PROJECT}/${VERSION}/opt/leopays_cdt/lib/cmake
...
echo "class LeopaysCdt < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/leopays-core/leopays.cdt/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/leopays-core/leopays.cdt/releases/download/v${VERSION}\"
