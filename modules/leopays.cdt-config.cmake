if(LEOPAYS_CDT_ROOT STREQUAL "" OR NOT LEOPAYS_CDT_ROOT)
   set(LEOPAYS_CDT_ROOT "@CDT_ROOT_DIR@")
endif()

list(APPEND CMAKE_MODULE_PATH ${LEOPAYS_CDT_ROOT}/lib/cmake/leopays.cdt)
if (NOT LEOPAYS_WASM_OLD_BEHAVIOR STREQUAL "Off")
    set(LEOPAYS_WASM_OLD_BEHAVIOR "On")
    include(LeoPaysWasmToolchain)
endif()

include(LeoPaysCDTMacros)
...
function(LEOPAYS_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
...
endfunction(LEOPAYS_CHECK_VERSION)
