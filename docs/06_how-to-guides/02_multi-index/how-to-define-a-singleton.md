...
| A full example project demonstrating the instantiation and usage of singleton can be found [here](https://github.com/leopays-core/leopays.cdt/tree/master/examples/singleton_example).
