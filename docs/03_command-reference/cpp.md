---
content_title: leopays-cpp tool
---

To manually compile the source code, use `leopays-cpp` and `leopays-ld` as if it were __clang__ and __lld__. All the includes and options specific to LeoPays and CDT are baked in.

```
USAGE: leopays-cpp [options] <input file> ...
