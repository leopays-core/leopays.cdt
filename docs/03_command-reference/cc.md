---
content_title: leopays-cc tool
---

To manually compile the source code, use `leopays-cc` and `leopays-ld` as if it were __clang__ and __lld__. All the includes and options specific to LeoPays and CDT are baked in.

```
USAGE: leopays-cc [options] <input file> ...
