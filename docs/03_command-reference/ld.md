---
content_title: leopays-ld tool
---

The leopays-ld tool is a the custom web assembly linker for LeoPays platform smart contracts.


```
USAGE: leopays-ld [options] <input file> ...
