...
You can find the implementation of `eosio::binary_extension` in the `leopays.cdt` repository in [binary_extension.hpp](https://github.com/leopays-core/leopays.cdt/blob/master/libraries/eosiolib/binary_extension.hpp).
