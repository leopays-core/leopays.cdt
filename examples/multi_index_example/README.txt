--- multi_index_example Project ---
 ...
 - After build -
   ...
   - You can then do a 'set contract' action with 'leopays-cli' and point to the './build/multi_index_example' directory
 ...
 -- How to build with leopays-cpp --
   - mkdir build
   - cd into the 'build' directory
   - run the command 'leopays-cpp -abigen ../src/multi_index_example.cpp -o multi_index_example.wasm -I ../include/'
